...
Begin by [creating a new repository](https://docs.github.com/en/desktop/installing-and-configuring-github-desktop/overview/creating-your-first-repository-using-github-desktop) in whatever working directory you wish to keep your files stored. Doing so enables you to record any changes made to the repository, changes to scripts, updated notes, removed files, etc. 
...
How you choose to structure your repository will depend on you, however, I recommend the following nested structure to make it easy to find and link to documents. Here are some examples of how I structure my repository.
